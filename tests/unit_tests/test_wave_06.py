...
def test_swap_best_by_category_reordered():
    ...
    assert len(tai.inventory) == 3
    assert len(jesse.inventory) == 3
    assert set(tai.inventory) == set([item_a, item_b, item_f])
    assert set(jesse.inventory) == set([item_c, item_d, item_e])
    assert set(tai.inventory) != set(jesse.inventory)
...
def test_swap_best_by_category_no_other_match_is_false():
    ...
    assert len(tai.inventory) == 3
    assert len(jesse.inventory) == 3
    assert set(tai.inventory) == set([item_a, item_b, item_c])
    assert set(jesse.inventory) == set([item_d, item_e, item_f])
